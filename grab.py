...
try:
    ...
    camera.GevSCPD.SetValue(1024)
    camera.GevSCPSPacketSize.SetValue(1500)

    if genicam.IsWritable(camera.ImageCompressionMode):
        pass
    else:
        raise pylon.RuntimeException("The camera doesn't support BaslerCompressionBeyond features")
    ...
    camera.BslImageCompressionRatio.SetValue(30.0)
