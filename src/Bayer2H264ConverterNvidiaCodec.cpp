...
//     }
    ...
    void BayerToH264ConverterNvidiaCodec::ShowEncoderCapability()
    {
     ...
     void  BayerToH264ConverterNvidiaCodec::initialize(){
        ...
        std::string folderName = "/home/hamit/Softwares/GrabberBaslerMultipleCameras/recordings/" + ss.str();
